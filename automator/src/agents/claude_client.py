...
class ClaudeClient:
    ...
    async def score_fit(
        ...
        user_prompt = (
            ...
            "(any timezone PST-EST is fine, up to 10% travel is fine). Deduct for: "
            "active security clearance required (-10), heavy travel 25%+ (-5), "
            "non-US location (-10).\n\n"
            "## Distribution Constraint\n"
            "You MUST use the full range. In a typical batch of 20 jobs:\n"
            "- ~3-5 should score 75+ (strong fits)\n"
            "- ~3-5 should score 50-74 (possible fits worth reviewing)\n"
            "- ~10-14 should score below 50 (poor fits)\n"
            "Do NOT cluster scores. If two jobs seem similar, find the differentiator "
            "and reflect it in at least a 5-point gap. Never give the same score to "
            "two different jobs.\n\n"
            "## Deal-Breaker Rules\n"
