...
const STATUS_DOT: Record<string, string> = {
  ...
  approved_for_apply: "bg-green-400",
  applying: "bg-yellow-400",
  applied: "bg-green-600",
  manually_applied: "bg-green-500",
  skipped: "bg-gray-300",
  rejected_by_user: "bg-red-400",
  apply_failed: "bg-red-600",
  resume_failed: "bg-red-500",
  extraction_failed: "bg-orange-400",
};
...
const STATUS_OPTIONS = [
  ...
  { value: "scored", label: "Scored (In Queue)" },
  { value: "approved_for_apply", label: "Approved" },
  { value: "applying", label: "Applying" },
  { value: "applied", label: "Applied" },
  { value: "manually_applied", label: "Manually Applied" },
  { value: "skipped", label: "Skipped" },
  { value: "rejected_by_user", label: "Rejected" },
